    ...
    <div>
      ...
      <div className="md:block hidden fixed top-4 right-4 z-10">
        <div className="flex flex-row">
          <a
            href="#main"
            className="rounded-full flex justify-center items-center shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200"
          >
            <AiOutlineHome size={20} />
            Home
          </a>
